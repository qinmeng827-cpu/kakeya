...
function AuthenticKakeyaSweepLab() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(([entry]) => {
      if (!entry?.isIntersecting || guideShownRef.current) return;
  ...
  return <div className={`sweep-lab sweep-lab-authentic${isFullscreen ? " is-fullscreen" : ""}`} ref={wrapRef}>
  ...
  return (
    <main style={typographyStyle} onClick={handleHashLink}>
      ...
      <section className="award-section award-banner" id="top">
        ...
        <div>
          <h2>2026年7月23日，<br />中国数学家王虹获得菲尔兹奖。</h2>
          <p>
